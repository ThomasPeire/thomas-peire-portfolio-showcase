  ...
  const skillCategories = [
    {
      ...
      icon: Code2,
      skills: ["C#", ".NET Core", ".NET Framework", "ASP.NET", "Entity Framework", "Microservices", "GraphQL", "RabbitMQ", "DDD", "Neo4j", "Event Sourcing", "Azure"],
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {category.skills.map((skill) => (
                  <span 
                    key={skill}
                    className="px-3 py-1 bg-secondary text-secondary-foreground rounded-full text-sm font-mono hover-glow transition-smooth border border-border/30"
                  >
                    {skill}
                  </span>
                ))}
